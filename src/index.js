	...
	render() {
		return(
			...
			<form onSubmit={this.handleSubmit} className='form-group'>
				...
				Date: <DatePicker name="date" className='form-control' onChange={this.handleChange} selected={this.state.startDate} /><br/>
				<button type="submit" className='btn btn-lg btn-primary form-control'>Submit</button>
			</form>
			{this.state.clicked && <Maps lattitude={this.state.lattitude} longitude={this.state.longitude} event={this.state.event} date={this.state.startDate} /> }
